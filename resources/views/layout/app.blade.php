...
<head>
  ...
  <<<<<<< HEAD <meta name="description" content="Your description here" />
  <meta name="keywords" content="Your keywords here" />
  =======
  <meta content="" name="description" />
  <meta content="" name="keywords" />
  >>>>>>> 49cc98707e14d17bf43e831de27c757d2112baf0
  ...
  <nav class="navbar navbar-light navbar-expand-lg">
    <div class="container">
      ...
      <div class="d-flex justify-content-evenly">
        @guest
        <<<<<<< HEAD <a href="{{ route('login') }}" class="primary-btn" style="background-color: #2eca6a; color: rgb(255, 255, 255); text-decoration: none; display: block; padding: 5px;">
          Login
          </a>
          @else
          <!-- User is logged in -->
